...
import com.ryderbelserion.cluster.utils.StringUtil;
...
public enum Messages {
    ...
    private String asString(Player player) {
        ...
        if (MiscUtil.isPapiActive() && player != null) {
            return PlaceholderAPI.setPlaceholders(player, MsgUtil.color(message));
        }
