...
public class ItemBuilder {
    ...
    private String parse(String message) {
        if (PluginSupport.PLACEHOLDERAPI.isPluginEnabled() && this.target != null) {
            return MsgUtil.color(PlaceholderAPI.setPlaceholders(this.target, message));
        }
    ...
    public ItemBuilder setMaterial(String type) {
        if (type == null || type.isEmpty()) {
            List.of(
                ...
                if (MiscUtil.isLogging()) this.plugin.getLogger().warning(line);
            });
        ...
        Material material = RegistryUtil.getMaterial(type.toLowerCase());
    ...
    public ItemBuilder setLore(List<String> lore) {
        if (lore != null) {
            ...
            for (String line : lore) {
                this.displayLore.add(MsgUtil.color(line));
            }
        }
    ...
    public ItemBuilder setLore(Player player, List<String> lore) {
        if (lore != null) {
            ...
            for (String line : lore) {
                this.displayLore.add(PlaceholderAPI.setPlaceholders(player, MsgUtil.color(line)));
            }
        }
    ...
    public ItemBuilder addLore(String lore) {
        if (lore != null) this.displayLore.add(MsgUtil.color(lore));
